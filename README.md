...
| `agent-codex` | Codex-runtime worker, scaffolds with `runtime: codex-app-server` and `model: gpt-6-astra` (see `templates/agent-codex/`) |
...
| `codex-app-server` | `CodexAppServerPTY` | `gpt-6-astra` | `plugins/cortextos-agent-skills/skills/<skill>/SKILL.md` (linked into `~/.codex/skills/<agent>__<skill>`) |
